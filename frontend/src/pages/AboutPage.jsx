...
export default function AboutPage() {
  ...
  const stages = [
    {
      ...
      model: 'all-MiniLM-L6-v2 / BGE-small (v2)', output: 'Retrieval score + top-k documents',
    },
    {
  ...
  const variants = [
    ...
    { name: 'Square Root', formula: 'T = T_s - (T_s - T_l) * sqrt(rs)', desc: 'Concave curve that drops the threshold quickly for moderate retrieval scores, then flattens. Smooth and continuous.', pros: 'Smooth transition, 2 params', cons: 'Sensitive to low retrieval' },
