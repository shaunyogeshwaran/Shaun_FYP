...
function Slider({ label, value, onChange, min = 0, max = 1, step = 0.01, tooltip, color = colors.primary }) {
  return (
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Slider
                  ...
                  value={pivot}
                  onChange={setPivot}
                  tooltip="Retrieval scores below this → STRICT verification mode"
                ...
                <Slider
                  ...
                  value={strict}
                  onChange={setStrict}
                  tooltip="Applied when retrieval confidence is LOW (below pivot)"
                  color={colors.hallucination}
                  step={0.01}
                />
                <Slider
                  label="Lenient Threshold"
                  value={lenient}
                  onChange={setLenient}
                  tooltip="Applied when retrieval confidence is HIGH (above pivot)"
